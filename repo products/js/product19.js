...
function handleClickAddCard() {
   ...
   btnAddCart.addEventListener('click', () => {
    ...
    const carLink = $('.cart-link')

    const carLinkHref = carLink.getAttribute('href')

    if(carLinkHref.includes('?amount')) {
        carLink.href = carLinkHref.replace(/\?amount=([\d]+)/,'') + '?amount=' + count
    } else {
        carLink.href = carLinkHref + '?amount=' + count
    }
